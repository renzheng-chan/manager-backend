...
public interface StucourseDao {
     ...
     * 统计总行数
     *
     * @param stucourse 查询条件
     * @return 总行数
     */
    long count(Stucourse stucourse);
     ...
     *
     * @param entities List<Stucourse> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<Stucourse> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<Stucourse> entities);
